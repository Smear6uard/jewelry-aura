...
export type CartFieldsFragment = (
  ...
  & { cost: { subtotalAmount: Pick<StorefrontTypes.MoneyV2, 'amount' | 'currencyCode'> }, lines: { nodes: Array<(
...
export type FeaturedCollectionQuery = { collection?: StorefrontTypes.Maybe<(
...
export type VariantAvailabilityFragment = (
